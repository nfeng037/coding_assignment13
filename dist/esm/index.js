...
var primaryFont = "'Playfair Display', serif";
var typeScale = {
    header1: '1.8rem',
    header2: '1.6rem',
    header3: '1.4rem',
...
var Button$1 = function (_a) {
    ...
    return (React.createElement(StyledButton, __assign({ type: "button", onClick: onClick, disabled: disabled, size: size }, props, { "aria-disabled": disabled ? true : undefined }), text));
};
...
var Label = function (_a) {
    ...
    return (React.createElement(StyledLabel, __assign({ size: size, htmlFor: htmlFor, disabled: disabled }, props), text));
};
...
var Text = function (_a) {
    ...
    return (React.createElement(StyledText, __assign({ types: types, bold: bold, italic: italic }, props), text));
};
...
var Card = function (_a) {
    ...
    return (React.createElement(CardContainer, { disabled: disabled },
        imageurl && React.createElement(Image, { src: imageurl, alt: title }),
        React.createElement(Title$1, null, title),
        React.createElement(Content, null, content),
        buttonText && (React.createElement(Button, { onClick: onButtonClick, disabled: disabled }, buttonText))));
};
...
var Dropdown = function (_a) {
    ...
    return (React.createElement(Select, { id: id, name: name, value: value, onChange: onChange, disabled: disabled }, options.map(function (option) { return (React.createElement("option", { key: option.value, value: option.value }, option.label)); })));
};
...
var HeroImage = function (_a) {
    ...
    return (React.createElement(HeroImageContainer, { imageUrl: imageUrl, disabled: disabled },
        title && React.createElement(Title, null, title),
        subtitle && React.createElement(Subtitle, null, subtitle),
        Text && (React.createElement(CallToActionButton, { onClick: OnClick }, Text))));
};
...
var Radio = function (_a) {
    ...
    return (React.createElement(StyledRadio, { type: "radio", id: id, name: name, value: value, checked: checked, disabled: disabled, onChange: onChange }));
};
...
var Table = function (props) {
    return React.createElement(StyledTable, __assign({}, props), props.children);
};
...
var Img = function (_a) {
    ...
    return (React.createElement(StyledImg, { src: src, alt: alt, width: width, height: height, disabled: disabled }));
};
var templateObject_1;

export { Button$1 as Button, Card, Dropdown, HeroImage as HeroImg, Img, Label, Radio, Table, Text, darkTheme, defaultTheme, errorColor, neutral, primaryColor, primaryFont, successColor, typeScale, warningColor };
